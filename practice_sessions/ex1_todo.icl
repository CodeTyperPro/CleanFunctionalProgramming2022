...
/*ch :: Char -> Char
ch chr
| to_int >= 97 && to_int<= 122 = toChar(to_int - 32)
| to_int >= 65 && to_int<= 90 = toChar(to_int + 32)
= toChar(to_int)
where to_int = toInt(chr)*/
...
check a b c = a rem 2 == 0 && b rem 13 == 0 && c
...
//sumOdd2 :: Int -> Int
sumOdd2 n 
| n < 0 = abort "m has to be positive"
| n == 1 || n == 0 = n
| n rem 2 <> 0 = n + sumOdd (n-2)
= sumOdd (n-1)
